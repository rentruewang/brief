...
Q_func = Q_Generator(voc_size=dataset.size,
                     ...
                     num_layers=args.rnn_layers).to(args.device)

reconstructor = Reconstructor(voc_size=dataset.size,
                              hidden_size=args.hidden,
                              time_steps=args.timesteps,
                              sos_value=sos_value,
                              max_len=args.maxlen,
...
discriminator = Discriminator(voc_size=dataset.size,
                              hidden_size=args.hidden,
                              time_steps=args.timesteps,
                              device=args.device,
                              num_layers=args.rnn_layers).to(args.device)
